      ...
      <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer}>
        <motion.div variants={fadeUp}>
          ...
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-foreground">
            <p>The Philippines has a specific problem that's creating a specific opportunity.</p>
            <p>Its US$40B+ IT-BPO sector — 1.8 million workers — is directly in the path of AI automation. This is a big threat. At the same time, healthcare export demand is rising and the government is doubling down on AI through NAISR 2.0. The reskilling pressure is coming from every direction at once.</p>
            <p>This combination puts the Philippines among Southeast Asia's most active skilling markets heading into 2026–2031. We estimate the compound opportunity across six sub-sectors at US$3.2–4.8B by 2030.</p>
            <p>The companies that capture it won't do so by building generically — they'll win by aligning with government priority verticals, owning the B2B corporate upskilling wave, and using AI-native delivery to operate at a cost structure incumbents can't match.</p>
